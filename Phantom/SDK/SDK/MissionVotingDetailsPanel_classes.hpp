...
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteResultAnimation_UNUSED) == 0x000288, "Member 'UMissionVotingDetailsPanel_C::VoteResultAnimation_UNUSED' has a wrong offset!");
...
static_assert(offsetof(UMissionVotingDetailsPanel_C, TimeTypeIcon_1) == 0x000350, "Member 'UMissionVotingDetailsPanel_C::TimeTypeIcon_1' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, Vote_Result_Glow) == 0x000358, "Member 'UMissionVotingDetailsPanel_C::Vote_Result_Glow' has a wrong offset!");
