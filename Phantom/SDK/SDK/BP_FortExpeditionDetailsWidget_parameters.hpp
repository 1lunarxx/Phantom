...
static_assert(sizeof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data) == 0x0003F0, "Wrong size on BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data");
...
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_GetUIDataForTag_ReturnValue) == 0x0003C0, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_GetUIDataForTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_GetContext_ReturnValue1) == 0x0003C8, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_GetItemsInSquad_ReturnValue) == 0x0003D0, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_GetItemsInSquad_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_CalculateTotalPower_ReturnValue) == 0x0003E0, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_CalculateTotalPower_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_FTrunc_ReturnValue) == 0x0003E4, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_CalculateExpeditionPercentageChanceForSuccess_ReturnValue) == 0x0003E8, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_CalculateExpeditionPercentageChanceForSuccess_ReturnValue' has a wrong offset!");
