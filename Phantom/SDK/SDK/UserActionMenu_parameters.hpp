...
public:
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue1;         // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UserActionMenu_C_ExecuteUbergraph_UserActionMenu, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000010, "Member 'UserActionMenu_C_ExecuteUbergraph_UserActionMenu::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UserActionMenu_C_ExecuteUbergraph_UserActionMenu, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x000048, "Member 'UserActionMenu_C_ExecuteUbergraph_UserActionMenu::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
...
public:
	...
	struct FLinearColor                           K2Node_Select1_Default;                            // 0x0030(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
