...
static_assert(sizeof(USocialImportButton_C) == 0x000B98, "Wrong size on USocialImportButton_C");
static_assert(offsetof(USocialImportButton_C, UberGraphFrame) == 0x000B58, "Member 'USocialImportButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USocialImportButton_C, CenterButtonTextWidget) == 0x000B60, "Member 'USocialImportButton_C::CenterButtonTextWidget' has a wrong offset!");
static_assert(offsetof(USocialImportButton_C, ContentBorder) == 0x000B68, "Member 'USocialImportButton_C::ContentBorder' has a wrong offset!");
static_assert(offsetof(USocialImportButton_C, LeftSideImage) == 0x000B70, "Member 'USocialImportButton_C::LeftSideImage' has a wrong offset!");
static_assert(offsetof(USocialImportButton_C, RightExtraContentSlot) == 0x000B78, "Member 'USocialImportButton_C::RightExtraContentSlot' has a wrong offset!");
static_assert(offsetof(USocialImportButton_C, TextOverride) == 0x000B80, "Member 'USocialImportButton_C::TextOverride' has a wrong offset!");
