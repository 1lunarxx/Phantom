...
static_assert(sizeof(Cinematic_TeamMics_C_Update) == 0x000270, "Wrong size on Cinematic_TeamMics_C_Update");
...
static_assert(offsetof(Cinematic_TeamMics_C_Update, Temp_bool_Variable2) == 0x000224, "Member 'Cinematic_TeamMics_C_Update::Temp_bool_Variable2' has a wrong offset!");
...
static_assert(offsetof(Cinematic_TeamMics_C_Update, CallFunc_GetContext_ReturnValue) == 0x000230, "Member 'Cinematic_TeamMics_C_Update::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(Cinematic_TeamMics_C_Update, CallFunc_IsValid_ReturnValue) == 0x000238, "Member 'Cinematic_TeamMics_C_Update::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Cinematic_TeamMics_C_Update, K2Node_Select_Default) == 0x000239, "Member 'Cinematic_TeamMics_C_Update::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Cinematic_TeamMics_C_Update, K2Node_Select1_Default) == 0x00023C, "Member 'Cinematic_TeamMics_C_Update::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(Cinematic_TeamMics_C_Update, CallFunc_IsNetIdFromLocalPlayersPlatform_ReturnValue) == 0x000240, "Member 'Cinematic_TeamMics_C_Update::CallFunc_IsNetIdFromLocalPlayersPlatform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Cinematic_TeamMics_C_Update, K2Node_Select2_Default) == 0x000248, "Member 'Cinematic_TeamMics_C_Update::K2Node_Select2_Default' has a wrong offset!");
