...
static_assert(offsetof(AlterationWidget_C_TriggerTextAnimation, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'AlterationWidget_C_TriggerTextAnimation::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
