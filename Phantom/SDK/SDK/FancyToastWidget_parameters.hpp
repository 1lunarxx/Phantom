...
static_assert(offsetof(FancyToastWidget_C_ExecuteUbergraph_FancyToastWidget, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000088, "Member 'FancyToastWidget_C_ExecuteUbergraph_FancyToastWidget::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FancyToastWidget_C_ExecuteUbergraph_FancyToastWidget, CallFunc_PlayAnimationAtTime_ReturnValue1) == 0x0000B0, "Member 'FancyToastWidget_C_ExecuteUbergraph_FancyToastWidget::CallFunc_PlayAnimationAtTime_ReturnValue1' has a wrong offset!");
