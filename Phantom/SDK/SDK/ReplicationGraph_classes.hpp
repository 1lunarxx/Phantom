...
static_assert(sizeof(UReplicationGraph) == 0x000488, "Wrong size on UReplicationGraph");
...
static_assert(sizeof(UBasicReplicationGraph) == 0x0004C0, "Wrong size on UBasicReplicationGraph");
static_assert(offsetof(UBasicReplicationGraph, GridNode) == 0x000488, "Member 'UBasicReplicationGraph::GridNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantNode) == 0x000490, "Member 'UBasicReplicationGraph::AlwaysRelevantNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantForConnectionList) == 0x000498, "Member 'UBasicReplicationGraph::AlwaysRelevantForConnectionList' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, ActorsWithoutNetConnection) == 0x0004A8, "Member 'UBasicReplicationGraph::ActorsWithoutNetConnection' has a wrong offset!");
...
static_assert(offsetof(UReplicationGraphNode_GridCell, DynamicNode) == 0x000150, "Member 'UReplicationGraphNode_GridCell::DynamicNode' has a wrong offset!");
static_assert(offsetof(UReplicationGraphNode_GridCell, DormancyNode) == 0x000158, "Member 'UReplicationGraphNode_GridCell::DormancyNode' has a wrong offset!");
...
static_assert(sizeof(UNetReplicationGraphConnection) == 0x0001F8, "Wrong size on UNetReplicationGraphConnection");
