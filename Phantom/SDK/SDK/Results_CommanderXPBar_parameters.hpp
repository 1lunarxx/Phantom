...
public:
	...
	int32                                         CallFunc_Array_LastIndex_ReturnValue2;             // 0x012C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FResults_CommanderXP_Data              CallFunc_Array_Get_Item1;                          // 0x0130(0x0028)(HasGetValueTypeHash)
	struct FResults_CommanderXP_Data              CallFunc_Array_Get_Item2;                          // 0x0158(0x0028)(HasGetValueTypeHash)
	...
	struct FResults_CommanderXP_Data              K2Node_MakeStruct_Results_CommanderXP_Data3;       // 0x01B0(0x0028)(HasGetValueTypeHash)
	...
	struct FResults_CommanderXP_Data              K2Node_MakeStruct_Results_CommanderXP_Data4;       // 0x01E0(0x0028)(HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue1;                   // 0x0208(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue2;                   // 0x020C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_LastIndex_ReturnValue3;             // 0x0210(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_214[0x4];                                      // 0x0214(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FResults_CommanderXP_Data              CallFunc_Array_Get_Item4;                          // 0x0218(0x0028)(HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue3;                   // 0x0240(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue4;                  // 0x0244(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue4;                   // 0x0248(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_24C[0x4];                                      // 0x024C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FResults_CommanderXP_Data              K2Node_MakeStruct_Results_CommanderXP_Data5;       // 0x0250(0x0028)(HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue5;                   // 0x0278(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerState*                       K2Node_DynamicCast_AsFort_Player_State;            // 0x0298(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueID_ReturnValue;                  // 0x02A8(0x0028)(HasGetValueTypeHash)
	float                                         CallFunc_GetLevelProgress_ReturnValue;             // 0x02D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetScoreReportIndex_ReturnValue;          // 0x02D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortUIXpInfo                          CallFunc_GetXpInfo_OutXpInfo;                      // 0x02D8(0x002C)(NoDestructor)
	bool                                          CallFunc_GetXpInfo_ReturnValue;                    // 0x0304(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(Results_CommanderXPBar_C_Initialize) == 0x000308, "Wrong size on Results_CommanderXPBar_C_Initialize");
...
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_LastIndex_ReturnValue2) == 0x00012C, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_LastIndex_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_Get_Item2) == 0x000158, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Add_IntInt_ReturnValue3) == 0x000180, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Add_IntInt_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_MakeStruct_Results_CommanderXP_Data3) == 0x0001B0, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_MakeStruct_Results_CommanderXP_Data3' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_MakeStruct_Results_CommanderXP_Data4) == 0x0001E0, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_MakeStruct_Results_CommanderXP_Data4' has a wrong offset!");
...
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_Add_ReturnValue2) == 0x00020C, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_Add_ReturnValue2' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_LastIndex_ReturnValue3) == 0x000210, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_LastIndex_ReturnValue3' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_Get_Item4) == 0x000218, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_Get_Item4' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_Add_ReturnValue3) == 0x000240, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_Add_ReturnValue3' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Add_IntInt_ReturnValue4) == 0x000244, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Add_IntInt_ReturnValue4' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_Add_ReturnValue4) == 0x000248, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_Add_ReturnValue4' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_MakeStruct_Results_CommanderXP_Data5) == 0x000250, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_MakeStruct_Results_CommanderXP_Data5' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Array_Add_ReturnValue5) == 0x000278, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Array_Add_ReturnValue5' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_GetOwningPlayer_ReturnValue) == 0x000280, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_DynamicCast_AsFort_Player_Controller) == 0x000288, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_DynamicCast_AsFort_Player_Controller' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_DynamicCast_bSuccess) == 0x000290, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_DynamicCast_AsFort_Player_State) == 0x000298, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_DynamicCast_AsFort_Player_State' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, K2Node_DynamicCast_bSuccess1) == 0x0002A0, "Member 'Results_CommanderXPBar_C_Initialize::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_Divide_FloatFloat_ReturnValue) == 0x0002A4, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_GetUniqueID_ReturnValue) == 0x0002A8, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_GetUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_GetLevelProgress_ReturnValue) == 0x0002D0, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_GetLevelProgress_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_GetScoreReportIndex_ReturnValue) == 0x0002D4, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_GetScoreReportIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_GetXpInfo_OutXpInfo) == 0x0002D8, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_GetXpInfo_OutXpInfo' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_Initialize, CallFunc_GetXpInfo_ReturnValue) == 0x000304, "Member 'Results_CommanderXPBar_C_Initialize::CallFunc_GetXpInfo_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Results_CommanderXPBar_C_PlayAnimationCommon) == 0x000010, "Wrong size on Results_CommanderXPBar_C_PlayAnimationCommon");
...
static_assert(offsetof(Results_CommanderXPBar_C_PlayAnimationCommon, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'Results_CommanderXPBar_C_PlayAnimationCommon::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
public:
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationAtTime_ReturnValue;          // 0x0088(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Results_CommanderXPBar_C_updateXpType) == 0x000090, "Wrong size on Results_CommanderXPBar_C_updateXpType");
...
static_assert(offsetof(Results_CommanderXPBar_C_updateXpType, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000088, "Member 'Results_CommanderXPBar_C_updateXpType::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
// Function Results_CommanderXPBar.Results_CommanderXPBar_C.UpdateCommanderLevel
// 0x0080 (0x0080 - 0x0000)
struct Results_CommanderXPBar_C_UpdateCommanderLevel final
{
public:
...
static_assert(alignof(Results_CommanderXPBar_C_UpdateCommanderLevel) == 0x000008, "Wrong alignment on Results_CommanderXPBar_C_UpdateCommanderLevel");
static_assert(sizeof(Results_CommanderXPBar_C_UpdateCommanderLevel) == 0x000080, "Wrong size on Results_CommanderXPBar_C_UpdateCommanderLevel");
static_assert(offsetof(Results_CommanderXPBar_C_UpdateCommanderLevel, CallFunc_Conv_IntToText_ReturnValue) == 0x000000, "Member 'Results_CommanderXPBar_C_UpdateCommanderLevel::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_UpdateCommanderLevel, K2Node_MakeStruct_FormatArgumentData) == 0x000018, "Member 'Results_CommanderXPBar_C_UpdateCommanderLevel::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_UpdateCommanderLevel, K2Node_MakeArray_Array) == 0x000058, "Member 'Results_CommanderXPBar_C_UpdateCommanderLevel::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Results_CommanderXPBar_C_UpdateCommanderLevel, CallFunc_Format_ReturnValue) == 0x000068, "Member 'Results_CommanderXPBar_C_UpdateCommanderLevel::CallFunc_Format_ReturnValue' has a wrong offset!");
