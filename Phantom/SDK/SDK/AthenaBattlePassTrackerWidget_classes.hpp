...
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, PassImageGlow) == 0x000288, "Member 'UAthenaBattlePassTrackerWidget_C::PassImageGlow' has a wrong offset!");
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, TierText) == 0x000290, "Member 'UAthenaBattlePassTrackerWidget_C::TierText' has a wrong offset!");
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, TrackerCB) == 0x000298, "Member 'UAthenaBattlePassTrackerWidget_C::TrackerCB' has a wrong offset!");
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, UpsellCB) == 0x0002A0, "Member 'UAthenaBattlePassTrackerWidget_C::UpsellCB' has a wrong offset!");
