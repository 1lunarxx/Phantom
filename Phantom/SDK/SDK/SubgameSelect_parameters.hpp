...
static_assert(offsetof(SubgameSelect_C_PopContentWidgetInternal, CallFunc_PopWidget_ReturnValue) == 0x000010, "Member 'SubgameSelect_C_PopContentWidgetInternal::CallFunc_PopWidget_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable2) == 0x000007, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable3) == 0x000008, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable3' has a wrong offset!");
