...
static_assert(offsetof(InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator, CallFunc_IsMobileGame_ReturnValue) == 0x000004, "Member 'InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator, CallFunc_GetContext_ReturnValue2) == 0x000038, "Member 'InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator, K2Node_CreateDelegate_OutputDelegate2) == 0x000040, "Member 'InteractionIndicator_C_ExecuteUbergraph_InteractionIndicator::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
...
static_assert(offsetof(InteractionIndicator_C_ShowPickupWidget, Temp_byte_Variable2) == 0x00004B, "Member 'InteractionIndicator_C_ShowPickupWidget::Temp_byte_Variable2' has a wrong offset!");
...
static_assert(offsetof(InteractionIndicator_C_ShowPickupWidget, Temp_byte_Variable3) == 0x00004D, "Member 'InteractionIndicator_C_ShowPickupWidget::Temp_byte_Variable3' has a wrong offset!");
...
static_assert(sizeof(InteractionIndicator_C_ShowBasicInteractionWidget) == 0x000008, "Wrong size on InteractionIndicator_C_ShowBasicInteractionWidget");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, Temp_byte_Variable) == 0x000000, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, Temp_byte_Variable1) == 0x000001, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, CallFunc_IsMobileGame_ReturnValue) == 0x000002, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, Temp_bool_Variable) == 0x000003, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, CallFunc_Greater_FloatFloat_ReturnValue) == 0x000004, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, CallFunc_BooleanAND_ReturnValue) == 0x000005, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, CallFunc_Greater_FloatFloat_ReturnValue1) == 0x000006, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::CallFunc_Greater_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_ShowBasicInteractionWidget, K2Node_Select_Default) == 0x000007, "Member 'InteractionIndicator_C_ShowBasicInteractionWidget::K2Node_Select_Default' has a wrong offset!");
...
static_assert(alignof(InteractionIndicator_C_UpdateKeybinds) == 0x000008, "Wrong alignment on InteractionIndicator_C_UpdateKeybinds");
static_assert(sizeof(InteractionIndicator_C_UpdateKeybinds) == 0x000010, "Wrong size on InteractionIndicator_C_UpdateKeybinds");
static_assert(offsetof(InteractionIndicator_C_UpdateKeybinds, CallFunc_GetContext_ReturnValue) == 0x000000, "Member 'InteractionIndicator_C_UpdateKeybinds::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(InteractionIndicator_C_UpdateKeybinds, CallFunc_GetUseActionName_ReturnValue) == 0x000008, "Member 'InteractionIndicator_C_UpdateKeybinds::CallFunc_GetUseActionName_ReturnValue' has a wrong offset!");
