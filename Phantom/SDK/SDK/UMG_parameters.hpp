...
static_assert(alignof(UserWidget_PlayAnimationAtTime) == 0x000008, "Wrong alignment on UserWidget_PlayAnimationAtTime");
static_assert(sizeof(UserWidget_PlayAnimationAtTime) == 0x000020, "Wrong size on UserWidget_PlayAnimationAtTime");
static_assert(offsetof(UserWidget_PlayAnimationAtTime, InAnimation) == 0x000000, "Member 'UserWidget_PlayAnimationAtTime::InAnimation' has a wrong offset!");
static_assert(offsetof(UserWidget_PlayAnimationAtTime, StartAtTime) == 0x000008, "Member 'UserWidget_PlayAnimationAtTime::StartAtTime' has a wrong offset!");
static_assert(offsetof(UserWidget_PlayAnimationAtTime, NumLoopsToPlay) == 0x00000C, "Member 'UserWidget_PlayAnimationAtTime::NumLoopsToPlay' has a wrong offset!");
static_assert(offsetof(UserWidget_PlayAnimationAtTime, PlayMode) == 0x000010, "Member 'UserWidget_PlayAnimationAtTime::PlayMode' has a wrong offset!");
static_assert(offsetof(UserWidget_PlayAnimationAtTime, PlaybackSpeed) == 0x000014, "Member 'UserWidget_PlayAnimationAtTime::PlaybackSpeed' has a wrong offset!");
static_assert(offsetof(UserWidget_PlayAnimationAtTime, ReturnValue) == 0x000018, "Member 'UserWidget_PlayAnimationAtTime::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(UserWidget_PlayAnimationTo) == 0x000028, "Wrong size on UserWidget_PlayAnimationTo");
...
static_assert(offsetof(UserWidget_PlayAnimationTo, ReturnValue) == 0x000020, "Member 'UserWidget_PlayAnimationTo::ReturnValue' has a wrong offset!");
