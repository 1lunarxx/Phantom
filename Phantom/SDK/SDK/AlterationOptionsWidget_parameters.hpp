...
static_assert(offsetof(AlterationOptionsWidget_C_ClearOptionsAndInitialize, CallFunc_DoAlterationOptionsExist_ReturnValue1) == 0x000011, "Member 'AlterationOptionsWidget_C_ClearOptionsAndInitialize::CallFunc_DoAlterationOptionsExist_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_ClearOptionsAndInitialize, K2Node_Select1_Default) == 0x000012, "Member 'AlterationOptionsWidget_C_ClearOptionsAndInitialize::K2Node_Select1_Default' has a wrong offset!");
...
public:
	...
	class UCommonButton*                          K2Node_DynamicCast_AsCommon_Button;                // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AlterationOptionsWidget_C_UnbindChildren) == 0x000048, "Wrong size on AlterationOptionsWidget_C_UnbindChildren");
...
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'AlterationOptionsWidget_C_UnbindChildren::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, CallFunc_Subtract_IntInt_ReturnValue) == 0x000020, "Member 'AlterationOptionsWidget_C_UnbindChildren::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, Temp_int_Variable) == 0x000024, "Member 'AlterationOptionsWidget_C_UnbindChildren::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, CallFunc_Add_IntInt_ReturnValue) == 0x000028, "Member 'AlterationOptionsWidget_C_UnbindChildren::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, CallFunc_GetChildAt_ReturnValue) == 0x000030, "Member 'AlterationOptionsWidget_C_UnbindChildren::CallFunc_GetChildAt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, K2Node_DynamicCast_AsCommon_Button) == 0x000038, "Member 'AlterationOptionsWidget_C_UnbindChildren::K2Node_DynamicCast_AsCommon_Button' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'AlterationOptionsWidget_C_UnbindChildren::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(AlterationOptionsWidget_C_UnbindChildren, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000041, "Member 'AlterationOptionsWidget_C_UnbindChildren::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
