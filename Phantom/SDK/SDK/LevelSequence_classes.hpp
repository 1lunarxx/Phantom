...
public:
	...
	uint8                                         bAutoPlay : 1;                                     // 0x0338(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_339[0x3];                                      // 0x0339(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x033C(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bOverrideInstanceData;                             // 0x0390(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x00033C, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
...
static_assert(offsetof(ALevelSequenceActor, bOverrideInstanceData) == 0x000390, "Member 'ALevelSequenceActor::bOverrideInstanceData' has a wrong offset!");
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x0228(0x0058)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
{
public:
	UMulticastDelegateProperty_                   OnCameraCut;                                       // 0x07D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000868, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0007D8, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
