...
static_assert(offsetof(UMissionActivationWidget_C, StartObjective_To_Global_Lockdown) == 0x0003A0, "Member 'UMissionActivationWidget_C::StartObjective_To_Global_Lockdown' has a wrong offset!");
static_assert(offsetof(UMissionActivationWidget_C, IncreaseDifficulty_To_Global_Lockdown) == 0x0003A8, "Member 'UMissionActivationWidget_C::IncreaseDifficulty_To_Global_Lockdown' has a wrong offset!");
static_assert(offsetof(UMissionActivationWidget_C, Close_Global_LockOut) == 0x0003B0, "Member 'UMissionActivationWidget_C::Close_Global_LockOut' has a wrong offset!");
static_assert(offsetof(UMissionActivationWidget_C, Open_Global_LockOut) == 0x0003B8, "Member 'UMissionActivationWidget_C::Open_Global_LockOut' has a wrong offset!");
...
static_assert(offsetof(UMissionActivationWidget_C, Timer_Glow) == 0x000498, "Member 'UMissionActivationWidget_C::Timer_Glow' has a wrong offset!");
