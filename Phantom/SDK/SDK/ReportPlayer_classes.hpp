...
static_assert(sizeof(UReportPlayer_C) == 0x000500, "Wrong size on UReportPlayer_C");
static_assert(offsetof(UReportPlayer_C, UberGraphFrame) == 0x0003C0, "Member 'UReportPlayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, ImageLoaded) == 0x0003C8, "Member 'UReportPlayer_C::ImageLoaded' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, ReportSent) == 0x0003D0, "Member 'UReportPlayer_C::ReportSent' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, Intro) == 0x0003D8, "Member 'UReportPlayer_C::Intro' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, B_Tab_AdditionalInfo) == 0x0003E0, "Member 'UReportPlayer_C::B_Tab_AdditionalInfo' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, B_Tab_PlayerName) == 0x0003E8, "Member 'UReportPlayer_C::B_Tab_PlayerName' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, B_Tab_Reason) == 0x0003F0, "Member 'UReportPlayer_C::B_Tab_Reason' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, Button_ReportFinished) == 0x0003F8, "Member 'UReportPlayer_C::Button_ReportFinished' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, CircularThrobber_0) == 0x000400, "Member 'UReportPlayer_C::CircularThrobber_0' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, CurrentReportStackingEntry) == 0x000408, "Member 'UReportPlayer_C::CurrentReportStackingEntry' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, Image_34) == 0x000410, "Member 'UReportPlayer_C::Image_34' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, Lightbox_0) == 0x000418, "Member 'UReportPlayer_C::Lightbox_0' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, SafeZone_0) == 0x000420, "Member 'UReportPlayer_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, SB_StackingEntry) == 0x000428, "Member 'UReportPlayer_C::SB_StackingEntry' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, Switcher_MainPanelContent) == 0x000430, "Member 'UReportPlayer_C::Switcher_MainPanelContent' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, Switcher_TabContent) == 0x000438, "Member 'UReportPlayer_C::Switcher_TabContent' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, T_PlayerReporting) == 0x000440, "Member 'UReportPlayer_C::T_PlayerReporting' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, VB_StackingEntryContainer) == 0x000448, "Member 'UReportPlayer_C::VB_StackingEntryContainer' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, ModalHeader_Title) == 0x000450, "Member 'UReportPlayer_C::ModalHeader_Title' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, TabTitle_PlayerName) == 0x000468, "Member 'UReportPlayer_C::TabTitle_PlayerName' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, TabTitle_AdditionalInfo) == 0x000480, "Member 'UReportPlayer_C::TabTitle_AdditionalInfo' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, TabTitle_TabReason) == 0x000498, "Member 'UReportPlayer_C::TabTitle_TabReason' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, ButtonLabel_SendPlayerReport) == 0x0004B0, "Member 'UReportPlayer_C::ButtonLabel_SendPlayerReport' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, TabButtons) == 0x0004C8, "Member 'UReportPlayer_C::TabButtons' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, BackAction) == 0x0004D8, "Member 'UReportPlayer_C::BackAction' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, StackingSelectedDisplays) == 0x0004E8, "Member 'UReportPlayer_C::StackingSelectedDisplays' has a wrong offset!");
static_assert(offsetof(UReportPlayer_C, ImagedLoadComplete) == 0x0004F8, "Member 'UReportPlayer_C::ImagedLoadComplete' has a wrong offset!");
