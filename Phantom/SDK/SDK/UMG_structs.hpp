...
static_assert(alignof(FBlueprintWidgetAnimationDelegateBinding) == 0x000008, "Wrong alignment on FBlueprintWidgetAnimationDelegateBinding");
static_assert(sizeof(FBlueprintWidgetAnimationDelegateBinding) == 0x000020, "Wrong size on FBlueprintWidgetAnimationDelegateBinding");
...
static_assert(offsetof(FBlueprintWidgetAnimationDelegateBinding, AnimationToBind) == 0x000008, "Member 'FBlueprintWidgetAnimationDelegateBinding::AnimationToBind' has a wrong offset!");
...
static_assert(offsetof(FBlueprintWidgetAnimationDelegateBinding, UserTag) == 0x000018, "Member 'FBlueprintWidgetAnimationDelegateBinding::UserTag' has a wrong offset!");
