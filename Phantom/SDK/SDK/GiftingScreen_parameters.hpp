...
static_assert(sizeof(GiftingScreen_C_ExecuteUbergraph_GiftingScreen) == 0x000070, "Wrong size on GiftingScreen_C_ExecuteUbergraph_GiftingScreen");
...
static_assert(offsetof(GiftingScreen_C_ExecuteUbergraph_GiftingScreen, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000040, "Member 'GiftingScreen_C_ExecuteUbergraph_GiftingScreen::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
