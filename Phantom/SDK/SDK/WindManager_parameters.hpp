...
static_assert(sizeof(WindManager_C_ExecuteUbergraph_WindManager) == 0x000860, "Wrong size on WindManager_C_ExecuteUbergraph_WindManager");
...
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_GetGlobalWindIntensityAndDirection_WindIntensity) == 0x000640, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_GetGlobalWindIntensityAndDirection_WindIntensity' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_GetGlobalWindIntensityAndDirection_WindDirection) == 0x000644, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_GetGlobalWindIntensityAndDirection_WindDirection' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_WindLocation) == 0x000650, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_WindLocation' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_WindInnerRadius) == 0x00065C, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_WindInnerRadius' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_WindOuterRadius) == 0x000660, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_WindOuterRadius' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_WindWorldDirection) == 0x000664, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_WindWorldDirection' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_WindMagnitude) == 0x000670, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_WindMagnitude' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_WindWorldBounds) == 0x000674, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_WindWorldBounds' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_bIsWindChanging) == 0x000690, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_bIsWindChanging' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_BreakWindImpulseCylinderAdvanced_bIsWindChangePending) == 0x000691, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_BreakWindImpulseCylinderAdvanced_bIsWindChangePending' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_Cross_VectorVector_ReturnValue) == 0x000694, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_Cross_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_Find_Matching_Wind_Mesh_Index_And_Write_Bool_Storm_Cyl_Mesh_Match) == 0x0006A0, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_Find_Matching_Wind_Mesh_Index_And_Write_Bool_Storm_Cyl_Mesh_Match' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_Find_Matching_Wind_Mesh_Index_And_Write_Bool_Wind_Cyl_Mesh_Array_Match_Index) == 0x0006A4, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_Find_Matching_Wind_Mesh_Index_And_Write_Bool_Wind_Cyl_Mesh_Array_Match_Index' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_SetWindMatVariables_NewParam) == 0x0006A8, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_SetWindMatVariables_NewParam' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, K2Node_CustomEvent_Radius) == 0x0006AC, "Member 'WindManager_C_ExecuteUbergraph_WindManager::K2Node_CustomEvent_Radius' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, K2Node_CustomEvent_ImpulseMagnitude) == 0x0006B0, "Member 'WindManager_C_ExecuteUbergraph_WindManager::K2Node_CustomEvent_ImpulseMagnitude' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_MakeVector_ReturnValue1) == 0x0006B4, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_MakeVector_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_Add_FloatFloat_ReturnValue) == 0x0006C0, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, K2Node_CustomEvent_Particle_Transform) == 0x0006D0, "Member 'WindManager_C_ExecuteUbergraph_WindManager::K2Node_CustomEvent_Particle_Transform' has a wrong offset!");
...
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, K2Node_DynamicCast_bSuccess) == 0x000850, "Member 'WindManager_C_ExecuteUbergraph_WindManager::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_K2_GetScalarParameterValue_ReturnValue) == 0x000854, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_K2_GetScalarParameterValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(WindManager_C_ExecuteUbergraph_WindManager, CallFunc_EqualEqual_IntInt_ReturnValue1) == 0x000858, "Member 'WindManager_C_ExecuteUbergraph_WindManager::CallFunc_EqualEqual_IntInt_ReturnValue1' has a wrong offset!");
