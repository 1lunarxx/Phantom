...
static_assert(sizeof(UAthenaPlayerInfo_C) == 0x000278, "Wrong size on UAthenaPlayerInfo_C");
static_assert(offsetof(UAthenaPlayerInfo_C, UberGraphFrame) == 0x000258, "Member 'UAthenaPlayerInfo_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerInfo_C, _Horizontal_Box__Player_Info) == 0x000260, "Member 'UAthenaPlayerInfo_C::_Horizontal_Box__Player_Info' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerInfo_C, LeaderImage) == 0x000268, "Member 'UAthenaPlayerInfo_C::LeaderImage' has a wrong offset!");
static_assert(offsetof(UAthenaPlayerInfo_C, TextPlayerName) == 0x000270, "Member 'UAthenaPlayerInfo_C::TextPlayerName' has a wrong offset!");
