...
static_assert(offsetof(AthenaSeasonReward_C_ExecuteUbergraph_AthenaSeasonReward, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'AthenaSeasonReward_C_ExecuteUbergraph_AthenaSeasonReward::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaSeasonReward_C_StartVariantTimer, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'AthenaSeasonReward_C_StartVariantTimer::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_StartVariantTimer, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'AthenaSeasonReward_C_StartVariantTimer::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
