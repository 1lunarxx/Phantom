...
public:
	...
	UMulticastDelegateProperty_                   OnTimecodeChange;                                  // 0x0270(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULinearTimecodeComponent) == 0x0002B0, "Wrong size on ULinearTimecodeComponent");
static_assert(offsetof(ULinearTimecodeComponent, MediaPlayer) == 0x000248, "Member 'ULinearTimecodeComponent::MediaPlayer' has a wrong offset!");
static_assert(offsetof(ULinearTimecodeComponent, DropTimecode) == 0x000250, "Member 'ULinearTimecodeComponent::DropTimecode' has a wrong offset!");
static_assert(offsetof(ULinearTimecodeComponent, OnTimecodeChange) == 0x000270, "Member 'ULinearTimecodeComponent::OnTimecodeChange' has a wrong offset!");
