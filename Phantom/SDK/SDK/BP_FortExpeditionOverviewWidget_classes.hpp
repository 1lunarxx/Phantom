...
static_assert(offsetof(UBP_FortExpeditionOverviewWidget_C, UberGraphFrame) == 0x000258, "Member 'UBP_FortExpeditionOverviewWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionOverviewWidget_C, BP_FortExpeditionDetailsWidget) == 0x000260, "Member 'UBP_FortExpeditionOverviewWidget_C::BP_FortExpeditionDetailsWidget' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionOverviewWidget_C, CommonWidgetSwitcher_0) == 0x000268, "Member 'UBP_FortExpeditionOverviewWidget_C::CommonWidgetSwitcher_0' has a wrong offset!");
static_assert(offsetof(UBP_FortExpeditionOverviewWidget_C, HeaderWithNav) == 0x000270, "Member 'UBP_FortExpeditionOverviewWidget_C::HeaderWithNav' has a wrong offset!");
