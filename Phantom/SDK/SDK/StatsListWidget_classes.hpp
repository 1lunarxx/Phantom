...
public:
	...
	struct FMargin                                RowMargin;                                         // 0x0280(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UStatsListWidget_C) == 0x0002A0, "Wrong size on UStatsListWidget_C");
static_assert(offsetof(UStatsListWidget_C, UberGraphFrame) == 0x000260, "Member 'UStatsListWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UStatsListWidget_C, HBoxCapMessage) == 0x000268, "Member 'UStatsListWidget_C::HBoxCapMessage' has a wrong offset!");
static_assert(offsetof(UStatsListWidget_C, ScrollBox_0) == 0x000270, "Member 'UStatsListWidget_C::ScrollBox_0' has a wrong offset!");
...
static_assert(offsetof(UStatsListWidget_C, List_Item_Time_Handle) == 0x000298, "Member 'UStatsListWidget_C::List_Item_Time_Handle' has a wrong offset!");
