...
static_assert(sizeof(UTeamMemberPedestal_XPBoostInfo_C) == 0x000268, "Wrong size on UTeamMemberPedestal_XPBoostInfo_C");
static_assert(offsetof(UTeamMemberPedestal_XPBoostInfo_C, UberGraphFrame) == 0x000258, "Member 'UTeamMemberPedestal_XPBoostInfo_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTeamMemberPedestal_XPBoostInfo_C, Border_0) == 0x000260, "Member 'UTeamMemberPedestal_XPBoostInfo_C::Border_0' has a wrong offset!");
