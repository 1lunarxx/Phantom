...
static_assert(offsetof(UCineCameraComponent, FocusPlaneVisualizationMesh) == 0x000838, "Member 'UCineCameraComponent::FocusPlaneVisualizationMesh' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, FocusPlaneVisualizationMaterial) == 0x000840, "Member 'UCineCameraComponent::FocusPlaneVisualizationMaterial' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DebugFocusPlaneComponent) == 0x000848, "Member 'UCineCameraComponent::DebugFocusPlaneComponent' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DebugFocusPlaneMID) == 0x000850, "Member 'UCineCameraComponent::DebugFocusPlaneMID' has a wrong offset!");
