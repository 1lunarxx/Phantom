...
static_assert(sizeof(ACheckExpeditionRewardsAction_C) == 0x000408, "Wrong size on ACheckExpeditionRewardsAction_C");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, UberGraphFrame) == 0x000388, "Member 'ACheckExpeditionRewardsAction_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, DefaultSceneRoot) == 0x000390, "Member 'ACheckExpeditionRewardsAction_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, RewardsDefinition) == 0x000398, "Member 'ACheckExpeditionRewardsAction_C::RewardsDefinition' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, ShowRewardsWidget) == 0x0003F8, "Member 'ACheckExpeditionRewardsAction_C::ShowRewardsWidget' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, Claimed_Reward_Widget) == 0x000400, "Member 'ACheckExpeditionRewardsAction_C::Claimed_Reward_Widget' has a wrong offset!");
