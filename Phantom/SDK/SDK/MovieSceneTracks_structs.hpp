...
static_assert(sizeof(FMovieSceneObjectPropertyTemplate) == 0x000100, "Wrong size on FMovieSceneObjectPropertyTemplate");
...
static_assert(sizeof(FMovieScenePrimitiveMaterialTemplate) == 0x0000E0, "Wrong size on FMovieScenePrimitiveMaterialTemplate");
