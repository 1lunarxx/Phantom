...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Constructor_HammerHitsHeal_C;    // 0x0A70(0x0008)(Transient, DuplicateTransient)
	struct FGameplayTagContainer                  TC_RequiredTags;                                   // 0x0A78(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UGA_Constructor_HammerHitsHeal_C) == 0x000A98, "Wrong size on UGA_Constructor_HammerHitsHeal_C");
static_assert(offsetof(UGA_Constructor_HammerHitsHeal_C, UberGraphFrame_GA_Constructor_HammerHitsHeal_C) == 0x000A70, "Member 'UGA_Constructor_HammerHitsHeal_C::UberGraphFrame_GA_Constructor_HammerHitsHeal_C' has a wrong offset!");
static_assert(offsetof(UGA_Constructor_HammerHitsHeal_C, TC_RequiredTags) == 0x000A78, "Member 'UGA_Constructor_HammerHitsHeal_C::TC_RequiredTags' has a wrong offset!");
