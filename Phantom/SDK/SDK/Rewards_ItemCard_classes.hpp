...
static_assert(offsetof(URewards_ItemCard_C, UberGraphFrame) == 0x000230, "Member 'URewards_ItemCard_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, AnimPopInPrimary) == 0x000238, "Member 'URewards_ItemCard_C::AnimPopInPrimary' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, AnimPopIn) == 0x000240, "Member 'URewards_ItemCard_C::AnimPopIn' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, ButtonInspect) == 0x000248, "Member 'URewards_ItemCard_C::ButtonInspect' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, CommonBorder_0) == 0x000250, "Member 'URewards_ItemCard_C::CommonBorder_0' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, ItemCardL) == 0x000258, "Member 'URewards_ItemCard_C::ItemCardL' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, ItemCardM) == 0x000260, "Member 'URewards_ItemCard_C::ItemCardM' has a wrong offset!");
static_assert(offsetof(URewards_ItemCard_C, ItemMaxedOutMessage) == 0x000268, "Member 'URewards_ItemCard_C::ItemMaxedOutMessage' has a wrong offset!");
