...
public:
	...
	class UImage*                                 TalkingHeadIcon;                                   // 0x0260(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UCommonTextBlock*                       TextSubtitles;                                     // 0x0270(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UTalkingHeadWidget_C) == 0x000280, "Wrong size on UTalkingHeadWidget_C");
static_assert(offsetof(UTalkingHeadWidget_C, UberGraphFrame) == 0x000258, "Member 'UTalkingHeadWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTalkingHeadWidget_C, TalkingHeadIcon) == 0x000260, "Member 'UTalkingHeadWidget_C::TalkingHeadIcon' has a wrong offset!");
static_assert(offsetof(UTalkingHeadWidget_C, TextName) == 0x000268, "Member 'UTalkingHeadWidget_C::TextName' has a wrong offset!");
static_assert(offsetof(UTalkingHeadWidget_C, TextSubtitles) == 0x000270, "Member 'UTalkingHeadWidget_C::TextSubtitles' has a wrong offset!");
static_assert(offsetof(UTalkingHeadWidget_C, VerticalBoxRoot) == 0x000278, "Member 'UTalkingHeadWidget_C::VerticalBoxRoot' has a wrong offset!");
