...
static_assert(sizeof(UMovieSceneObjectPropertySection) == 0x000198, "Wrong size on UMovieSceneObjectPropertySection");
...
static_assert(sizeof(UMovieScenePrimitiveMaterialSection) == 0x000198, "Wrong size on UMovieScenePrimitiveMaterialSection");
