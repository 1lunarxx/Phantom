...
static_assert(sizeof(UGAB_Hunting_C) == 0x0009B0, "Wrong size on UGAB_Hunting_C");
static_assert(offsetof(UGAB_Hunting_C, UberGraphFrame) == 0x000940, "Member 'UGAB_Hunting_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, EQS_Hunting_Query) == 0x000948, "Member 'UGAB_Hunting_C::EQS_Hunting_Query' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, EQS_Grid_Half_Size) == 0x000950, "Member 'UGAB_Hunting_C::EQS_Grid_Half_Size' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, EQS_Density) == 0x000954, "Member 'UGAB_Hunting_C::EQS_Density' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, HuntingMoveTaskName) == 0x000958, "Member 'UGAB_Hunting_C::HuntingMoveTaskName' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, MyFortAIController) == 0x000960, "Member 'UGAB_Hunting_C::MyFortAIController' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, HuntingTarget) == 0x000968, "Member 'UGAB_Hunting_C::HuntingTarget' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, LastTimeStartedHunting) == 0x000970, "Member 'UGAB_Hunting_C::LastTimeStartedHunting' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, HuntingRestartDelta) == 0x000974, "Member 'UGAB_Hunting_C::HuntingRestartDelta' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, MovementTask) == 0x000978, "Member 'UGAB_Hunting_C::MovementTask' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, GoalDistancesOnCompleteMove) == 0x000980, "Member 'UGAB_Hunting_C::GoalDistancesOnCompleteMove' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, PawnPositionsOnCompletedMove) == 0x000990, "Member 'UGAB_Hunting_C::PawnPositionsOnCompletedMove' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, ShouldAbortHunting) == 0x0009A0, "Member 'UGAB_Hunting_C::ShouldAbortHunting' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, MinGoalDistChange) == 0x0009A4, "Member 'UGAB_Hunting_C::MinGoalDistChange' has a wrong offset!");
static_assert(offsetof(UGAB_Hunting_C, MinPawnDistChange) == 0x0009A8, "Member 'UGAB_Hunting_C::MinPawnDistChange' has a wrong offset!");
