...
static_assert(sizeof(UGAB_PlayerDBNOResurrect_C) == 0x000980, "Wrong size on UGAB_PlayerDBNOResurrect_C");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, UberGraphFrame) == 0x000940, "Member 'UGAB_PlayerDBNOResurrect_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, EC_AppliedEffect) == 0x000948, "Member 'UGAB_PlayerDBNOResurrect_C::EC_AppliedEffect' has a wrong offset!");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, PlayerPawn) == 0x000950, "Member 'UGAB_PlayerDBNOResurrect_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, KnockbackMagnitude) == 0x000958, "Member 'UGAB_PlayerDBNOResurrect_C::KnockbackMagnitude' has a wrong offset!");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, HitActors) == 0x000960, "Member 'UGAB_PlayerDBNOResurrect_C::HitActors' has a wrong offset!");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, KnockbackStunGE) == 0x000970, "Member 'UGAB_PlayerDBNOResurrect_C::KnockbackStunGE' has a wrong offset!");
static_assert(offsetof(UGAB_PlayerDBNOResurrect_C, BP_VictoryDrone) == 0x000978, "Member 'UGAB_PlayerDBNOResurrect_C::BP_VictoryDrone' has a wrong offset!");
