...
static_assert(offsetof(FRigHierarchyRef, Name) == 0x000010, "Member 'FRigHierarchyRef::Name' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRigBase) == 0x000048, "Wrong size on FAnimNode_ControlRigBase");
static_assert(offsetof(FAnimNode_ControlRigBase, RigHierarchyItemNameMapping) == 0x000030, "Member 'FAnimNode_ControlRigBase::RigHierarchyItemNameMapping' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, NodeMappingContainer) == 0x000040, "Member 'FAnimNode_ControlRigBase::NodeMappingContainer' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRig_ExternalSource) == 0x000050, "Wrong size on FAnimNode_ControlRig_ExternalSource");
static_assert(offsetof(FAnimNode_ControlRig_ExternalSource, ControlRig) == 0x000048, "Member 'FAnimNode_ControlRig_ExternalSource::ControlRig' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRig) == 0x000068, "Wrong size on FAnimNode_ControlRig");
static_assert(offsetof(FAnimNode_ControlRig, Source) == 0x000048, "Member 'FAnimNode_ControlRig::Source' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, ControlRigClass) == 0x000058, "Member 'FAnimNode_ControlRig::ControlRigClass' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, ControlRig) == 0x000060, "Member 'FAnimNode_ControlRig::ControlRig' has a wrong offset!");
...
{
public:
	uint8                                         Pad_800[0x1B0];                                    // 0x0800(0x01B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x0009B0, "Wrong size on FControlRigSequencerAnimInstanceProxy");
