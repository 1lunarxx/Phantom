...
static_assert(sizeof(AbilitiesPageTile_C_SetAbilityItemInfo) == 0x0000C8, "Wrong size on AbilitiesPageTile_C_SetAbilityItemInfo");
...
static_assert(sizeof(AbilitiesPageTile_C_SetAbilityPerkInfo) == 0x000168, "Wrong size on AbilitiesPageTile_C_SetAbilityPerkInfo");
...
static_assert(offsetof(AbilitiesPageTile_C_SetAbilityPerkInfo, CallFunc_GetGrantedAbilityKit_ReturnValue) == 0x000160, "Member 'AbilitiesPageTile_C_SetAbilityPerkInfo::CallFunc_GetGrantedAbilityKit_ReturnValue' has a wrong offset!");
