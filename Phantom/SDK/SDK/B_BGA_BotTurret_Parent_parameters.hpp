...
static_assert(alignof(B_BGA_BotTurret_Parent_C_SetGunSpawnRotFromSocket) == 0x000008, "Wrong alignment on B_BGA_BotTurret_Parent_C_SetGunSpawnRotFromSocket");
static_assert(sizeof(B_BGA_BotTurret_Parent_C_SetGunSpawnRotFromSocket) == 0x000018, "Wrong size on B_BGA_BotTurret_Parent_C_SetGunSpawnRotFromSocket");
