...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Ninja_SwordHitsHeal_C;           // 0x0A70(0x0008)(Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Ninja_SwordHitsHeal_C) == 0x000A98, "Wrong size on UGA_Ninja_SwordHitsHeal_C");
static_assert(offsetof(UGA_Ninja_SwordHitsHeal_C, UberGraphFrame_GA_Ninja_SwordHitsHeal_C) == 0x000A70, "Member 'UGA_Ninja_SwordHitsHeal_C::UberGraphFrame_GA_Ninja_SwordHitsHeal_C' has a wrong offset!");
static_assert(offsetof(UGA_Ninja_SwordHitsHeal_C, TC_RequiredTags) == 0x000A78, "Member 'UGA_Ninja_SwordHitsHeal_C::TC_RequiredTags' has a wrong offset!");
