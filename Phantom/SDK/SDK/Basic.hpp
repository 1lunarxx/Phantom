...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05287C88;
	constexpr int32 AppendString      = 0x017F3C80;
	constexpr int32 GNames            = 0x0571C138;
	constexpr int32 GWorld_Addr       = 0x05820EA0;
	constexpr int32 ProcessEvent      = 0x019A0E50;
