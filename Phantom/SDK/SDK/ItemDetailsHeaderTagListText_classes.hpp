...
static_assert(offsetof(UItemDetailsHeaderTagListText_C, UberGraphFrame) == 0x000278, "Member 'UItemDetailsHeaderTagListText_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemDetailsHeaderTagListText_C, TagListTextBlock) == 0x000280, "Member 'UItemDetailsHeaderTagListText_C::TagListTextBlock' has a wrong offset!");
