...
public:
	...
	struct FSoftObjectPath                        GameDefaultMap;                                    // 0x0098(0x0018)(Edit, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftObjectPath                        ServerDefaultMap;                                  // 0x00B0(0x0018)(Edit, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         GlobalDefaultGameMode;                             // 0x00C8(0x0018)(Edit, Config, NoClear, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         GlobalDefaultServerGameMode;                       // 0x00E0(0x0018)(Edit, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
