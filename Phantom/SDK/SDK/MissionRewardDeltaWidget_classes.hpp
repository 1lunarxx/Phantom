...
static_assert(sizeof(UMissionRewardDeltaWidget_C) == 0x000268, "Wrong size on UMissionRewardDeltaWidget_C");
...
static_assert(offsetof(UMissionRewardDeltaWidget_C, Border_DeltaBacking) == 0x000230, "Member 'UMissionRewardDeltaWidget_C::Border_DeltaBacking' has a wrong offset!");
static_assert(offsetof(UMissionRewardDeltaWidget_C, RewardDelta) == 0x000238, "Member 'UMissionRewardDeltaWidget_C::RewardDelta' has a wrong offset!");
static_assert(offsetof(UMissionRewardDeltaWidget_C, RewardImage) == 0x000240, "Member 'UMissionRewardDeltaWidget_C::RewardImage' has a wrong offset!");
static_assert(offsetof(UMissionRewardDeltaWidget_C, RewardName) == 0x000248, "Member 'UMissionRewardDeltaWidget_C::RewardName' has a wrong offset!");
static_assert(offsetof(UMissionRewardDeltaWidget_C, RewardQuantity) == 0x000250, "Member 'UMissionRewardDeltaWidget_C::RewardQuantity' has a wrong offset!");
static_assert(offsetof(UMissionRewardDeltaWidget_C, ItemDelta) == 0x000258, "Member 'UMissionRewardDeltaWidget_C::ItemDelta' has a wrong offset!");
