...
static_assert(sizeof(AOnlineBeacon) == 0x000358, "Wrong size on AOnlineBeacon");
...
static_assert(sizeof(AOnlineBeaconClient) == 0x0003A8, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x000358, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x000360, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x000368, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x0003A8, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(UIpConnection) == 0x001988, "Wrong size on UIpConnection");
...
static_assert(sizeof(AOnlineBeaconHost) == 0x000410, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x000358, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x000360, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
static_assert(sizeof(APartyBeaconClient) == 0x000458, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x0003D8, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x0003E8, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x000428, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x000429, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x00042A, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x0005E0, "Wrong size on UVoipListenerSynthComponent");
