...
static_assert(sizeof(PackResource_C_OnTouchStarted) == 0x000220, "Wrong size on PackResource_C_OnTouchStarted");
...
static_assert(offsetof(PackResource_C_OnTouchStarted, CallFunc_Now_ReturnValue) == 0x000160, "Member 'PackResource_C_OnTouchStarted::CallFunc_Now_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchStarted, CallFunc_Handled_ReturnValue) == 0x000168, "Member 'PackResource_C_OnTouchStarted::CallFunc_Handled_ReturnValue' has a wrong offset!");
...
{
public:
	struct FSlateColor                            CallFunc_GetCountOpacity_SlateColor;               // 0x0000(0x0028)()
...
static_assert(offsetof(PackResource_C_RefreshSmallerCountLayout, CallFunc_GetCountOpacity_SlateColor) == 0x000000, "Member 'PackResource_C_RefreshSmallerCountLayout::CallFunc_GetCountOpacity_SlateColor' has a wrong offset!");
static_assert(offsetof(PackResource_C_RefreshSmallerCountLayout, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000028, "Member 'PackResource_C_RefreshSmallerCountLayout::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_RefreshSmallerCountLayout, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00002C, "Member 'PackResource_C_RefreshSmallerCountLayout::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
...
struct PackResource_C_OnTouchMoved final
{
public:
	struct FGeometry                              MyGeometry;                                        // 0x0000(0x0038)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FPointerEvent                          InTouchEvent;                                      // 0x0038(0x0070)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	struct FDateTime                              CallFunc_Now_ReturnValue;                          // 0x0220(0x0008)(NoDestructor, HasGetValueTypeHash)
	struct FEventReply                            CallFunc_Handled_ReturnValue;                      // 0x0228(0x00B8)()
	struct FTimespan                              CallFunc_Subtract_DateTimeDateTime_ReturnValue;    // 0x02E0(0x0008)(NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(PackResource_C_OnTouchMoved) == 0x000008, "Wrong alignment on PackResource_C_OnTouchMoved");
static_assert(sizeof(PackResource_C_OnTouchMoved) == 0x0003A8, "Wrong size on PackResource_C_OnTouchMoved");
static_assert(offsetof(PackResource_C_OnTouchMoved, MyGeometry) == 0x000000, "Member 'PackResource_C_OnTouchMoved::MyGeometry' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, InTouchEvent) == 0x000038, "Member 'PackResource_C_OnTouchMoved::InTouchEvent' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, ReturnValue) == 0x0000A8, "Member 'PackResource_C_OnTouchMoved::ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, Temp_bool_Variable) == 0x000160, "Member 'PackResource_C_OnTouchMoved::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, CallFunc_Unhandled_ReturnValue) == 0x000168, "Member 'PackResource_C_OnTouchMoved::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, CallFunc_Now_ReturnValue) == 0x000220, "Member 'PackResource_C_OnTouchMoved::CallFunc_Now_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, CallFunc_Handled_ReturnValue) == 0x000228, "Member 'PackResource_C_OnTouchMoved::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, CallFunc_Subtract_DateTimeDateTime_ReturnValue) == 0x0002E0, "Member 'PackResource_C_OnTouchMoved::CallFunc_Subtract_DateTimeDateTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, CallFunc_GetTotalMilliseconds_ReturnValue) == 0x0002E8, "Member 'PackResource_C_OnTouchMoved::CallFunc_GetTotalMilliseconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, CallFunc_GreaterEqual_FloatFloat_ReturnValue) == 0x0002EC, "Member 'PackResource_C_OnTouchMoved::CallFunc_GreaterEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchMoved, K2Node_Select_Default) == 0x0002F0, "Member 'PackResource_C_OnTouchMoved::K2Node_Select_Default' has a wrong offset!");

// Function PackResource.PackResource_C.OnTouchEnded
// 0x03A8 (0x03A8 - 0x0000)
struct PackResource_C_OnTouchEnded final
{
public:
	struct FGeometry                              MyGeometry;                                        // 0x0000(0x0038)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FPointerEvent                          InTouchEvent;                                      // 0x0038(0x0070)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
static_assert(alignof(PackResource_C_OnTouchEnded) == 0x000008, "Wrong alignment on PackResource_C_OnTouchEnded");
static_assert(sizeof(PackResource_C_OnTouchEnded) == 0x0003A8, "Wrong size on PackResource_C_OnTouchEnded");
static_assert(offsetof(PackResource_C_OnTouchEnded, MyGeometry) == 0x000000, "Member 'PackResource_C_OnTouchEnded::MyGeometry' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, InTouchEvent) == 0x000038, "Member 'PackResource_C_OnTouchEnded::InTouchEvent' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, ReturnValue) == 0x0000A8, "Member 'PackResource_C_OnTouchEnded::ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, Temp_bool_Variable) == 0x000160, "Member 'PackResource_C_OnTouchEnded::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, CallFunc_Unhandled_ReturnValue) == 0x000168, "Member 'PackResource_C_OnTouchEnded::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, CallFunc_Now_ReturnValue) == 0x000220, "Member 'PackResource_C_OnTouchEnded::CallFunc_Now_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, CallFunc_Handled_ReturnValue) == 0x000228, "Member 'PackResource_C_OnTouchEnded::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, CallFunc_Subtract_DateTimeDateTime_ReturnValue) == 0x0002E0, "Member 'PackResource_C_OnTouchEnded::CallFunc_Subtract_DateTimeDateTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, CallFunc_GetTotalMilliseconds_ReturnValue) == 0x0002E8, "Member 'PackResource_C_OnTouchEnded::CallFunc_GetTotalMilliseconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, CallFunc_GreaterEqual_FloatFloat_ReturnValue) == 0x0002EC, "Member 'PackResource_C_OnTouchEnded::CallFunc_GreaterEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(PackResource_C_OnTouchEnded, K2Node_Select_Default) == 0x0002F0, "Member 'PackResource_C_OnTouchEnded::K2Node_Select_Default' has a wrong offset!");
