...
static_assert(offsetof(FLayerBlendInput, HeightInput) == 0x000028, "Member 'FLayerBlendInput::HeightInput' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, PreviewWeight) == 0x000040, "Member 'FLayerBlendInput::PreviewWeight' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, ConstLayerInput) == 0x000044, "Member 'FLayerBlendInput::ConstLayerInput' has a wrong offset!");
