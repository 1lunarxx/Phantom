...
static_assert(offsetof(FrontEndRewards_Widget_C_HandleCurrentRewardDisplayed, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'FrontEndRewards_Widget_C_HandleCurrentRewardDisplayed::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FrontEndRewards_Widget_C_BindEvents, K2Node_CreateDelegate_OutputDelegate2) == 0x000030, "Member 'FrontEndRewards_Widget_C_BindEvents::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_BindEvents, K2Node_CreateDelegate_OutputDelegate3) == 0x000040, "Member 'FrontEndRewards_Widget_C_BindEvents::K2Node_CreateDelegate_OutputDelegate3' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_BindEvents, K2Node_CreateDelegate_OutputDelegate4) == 0x000050, "Member 'FrontEndRewards_Widget_C_BindEvents::K2Node_CreateDelegate_OutputDelegate4' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_BindEvents, K2Node_CreateDelegate_OutputDelegate5) == 0x000060, "Member 'FrontEndRewards_Widget_C_BindEvents::K2Node_CreateDelegate_OutputDelegate5' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_BindEvents, K2Node_CreateDelegate_OutputDelegate6) == 0x000070, "Member 'FrontEndRewards_Widget_C_BindEvents::K2Node_CreateDelegate_OutputDelegate6' has a wrong offset!");
...
static_assert(offsetof(FrontEndRewards_Widget_C_TransitionIn, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'FrontEndRewards_Widget_C_TransitionIn::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
public:
	...
	TDelegate<void(bool Succeeded, TArray<struct FFortItemInstanceQuantityPair>& Rewards)> K2Node_CreateDelegate_OutputDelegate2;             // 0x0030(0x0010)(ZeroConstructor, NoDestructor)
	class UFortRewardNotificationSubWidget*       CallFunc_Array_Get_Item;                           // 0x0040(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x004C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(int32 Index, class UFortItem* Item)> K2Node_CreateDelegate_OutputDelegate3;             // 0x0050(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate4;             // 0x0060(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& ClaimedRewards)> K2Node_CreateDelegate_OutputDelegate5;             // 0x0070(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate6;             // 0x0080(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)> K2Node_CreateDelegate_OutputDelegate7;             // 0x0090(0x0010)(ZeroConstructor, NoDestructor)
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue;                   // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortQuestManager*                      CallFunc_GetQuestManager_ReturnValue;              // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)> K2Node_CreateDelegate_OutputDelegate8;             // 0x00C0(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)> K2Node_CreateDelegate_OutputDelegate9;             // 0x00D8(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const struct FFortCollectionBookRewards& RewardClaimed, bool bSuccess, TArray<struct FFortItemInstanceQuantityPair>& ActualRewards)> K2Node_CreateDelegate_OutputDelegate10;            // 0x00E8(0x0010)(ZeroConstructor, NoDestructor)
	class UFortMcpContext*                        CallFunc_GetContext_ReturnValue3;                  // 0x00F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UFortQuestItem* Quest, TArray<struct FFortItemInstanceQuantityPair>& Rewards)> K2Node_CreateDelegate_OutputDelegate11;            // 0x0100(0x0010)(ZeroConstructor, NoDestructor)
	class UFortMcpContext*                        CallFunc_GetContext_ReturnValue4;                  // 0x0110(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(FrontEndRewards_Widget_C_UnbindEvents) == 0x000118, "Wrong size on FrontEndRewards_Widget_C_UnbindEvents");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, Temp_int_Array_Index_Variable) == 0x000000, "Member 'FrontEndRewards_Widget_C_UnbindEvents::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, Temp_int_Loop_Counter_Variable) == 0x000004, "Member 'FrontEndRewards_Widget_C_UnbindEvents::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_Add_IntInt_ReturnValue) == 0x000008, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate2) == 0x000030, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_Array_Get_Item) == 0x000040, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_Array_Length_ReturnValue) == 0x000048, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_Less_IntInt_ReturnValue) == 0x00004C, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate3) == 0x000050, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate3' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate4) == 0x000060, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate4' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate5) == 0x000070, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate5' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate6) == 0x000080, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate6' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate7) == 0x000090, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate7' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetContext_ReturnValue) == 0x0000A0, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetContext_ReturnValue1) == 0x0000A8, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetQuestManager_ReturnValue) == 0x0000B0, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetQuestManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetCollectionBookManager_ReturnValue) == 0x0000B8, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetCollectionBookManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate8) == 0x0000C0, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate8' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetContext_ReturnValue2) == 0x0000D0, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate9) == 0x0000D8, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate9' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate10) == 0x0000E8, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate10' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetContext_ReturnValue3) == 0x0000F8, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetContext_ReturnValue3' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, K2Node_CreateDelegate_OutputDelegate11) == 0x000100, "Member 'FrontEndRewards_Widget_C_UnbindEvents::K2Node_CreateDelegate_OutputDelegate11' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_UnbindEvents, CallFunc_GetContext_ReturnValue4) == 0x000110, "Member 'FrontEndRewards_Widget_C_UnbindEvents::CallFunc_GetContext_ReturnValue4' has a wrong offset!");
...
static_assert(sizeof(FrontEndRewards_Widget_C_InitializeRewardsData) == 0x000140, "Wrong size on FrontEndRewards_Widget_C_InitializeRewardsData");
...
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Array_Length_ReturnValue1) == 0x000110, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Array_Length_ReturnValue1' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Less_IntInt_ReturnValue1) == 0x000114, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Less_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Array_Get_Item2) == 0x000118, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Array_Length_ReturnValue2) == 0x000120, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Array_Length_ReturnValue2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Array_Get_Item3) == 0x000128, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Array_Get_Item3' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Less_IntInt_ReturnValue2) == 0x000130, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Less_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Array_Length_ReturnValue3) == 0x000134, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Array_Length_ReturnValue3' has a wrong offset!");
static_assert(offsetof(FrontEndRewards_Widget_C_InitializeRewardsData, CallFunc_Less_IntInt_ReturnValue3) == 0x000138, "Member 'FrontEndRewards_Widget_C_InitializeRewardsData::CallFunc_Less_IntInt_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(FrontEndRewards_Widget_C_HandleOnGiftBoxRemoved, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'FrontEndRewards_Widget_C_HandleOnGiftBoxRemoved::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
