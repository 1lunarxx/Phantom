...
static_assert(sizeof(UQuestMiniTile2_C) == 0x000300, "Wrong size on UQuestMiniTile2_C");
static_assert(offsetof(UQuestMiniTile2_C, UberGraphFrame) == 0x000248, "Member 'UQuestMiniTile2_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, PulseSelectedTileBackground) == 0x000250, "Member 'UQuestMiniTile2_C::PulseSelectedTileBackground' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, PulseSelectedTileBackgroundAndIcon) == 0x000258, "Member 'UQuestMiniTile2_C::PulseSelectedTileBackgroundAndIcon' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, BorderShell) == 0x000260, "Member 'UQuestMiniTile2_C::BorderShell' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, BottomTextQuest) == 0x000268, "Member 'UQuestMiniTile2_C::BottomTextQuest' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Node_Background) == 0x000270, "Member 'UQuestMiniTile2_C::Node_Background' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Node_Selected) == 0x000278, "Member 'UQuestMiniTile2_C::Node_Selected' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, QuestTypeIcon) == 0x000280, "Member 'UQuestMiniTile2_C::QuestTypeIcon' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, ScaleBox_0) == 0x000288, "Member 'UQuestMiniTile2_C::ScaleBox_0' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, SizeBoxShell) == 0x000290, "Member 'UQuestMiniTile2_C::SizeBoxShell' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, TopTextQuest) == 0x000298, "Member 'UQuestMiniTile2_C::TopTextQuest' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Quest_Item_Def) == 0x0002A0, "Member 'UQuestMiniTile2_C::Quest_Item_Def' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Proto_Item_Def) == 0x0002A8, "Member 'UQuestMiniTile2_C::Proto_Item_Def' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, TilePulseTimer) == 0x0002B0, "Member 'UQuestMiniTile2_C::TilePulseTimer' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Show_Text_On_Bottom) == 0x0002B8, "Member 'UQuestMiniTile2_C::Show_Text_On_Bottom' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, UseHighContrast) == 0x0002B9, "Member 'UQuestMiniTile2_C::UseHighContrast' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, OverrideWidth) == 0x0002BA, "Member 'UQuestMiniTile2_C::OverrideWidth' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, OverrideHeight) == 0x0002BB, "Member 'UQuestMiniTile2_C::OverrideHeight' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Width) == 0x0002BC, "Member 'UQuestMiniTile2_C::Width' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Height) == 0x0002C0, "Member 'UQuestMiniTile2_C::Height' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, HandleQuestTileHovered) == 0x0002C8, "Member 'UQuestMiniTile2_C::HandleQuestTileHovered' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, HandleQuestTileUnhovered) == 0x0002D8, "Member 'UQuestMiniTile2_C::HandleQuestTileUnhovered' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, AllowSelection) == 0x0002E8, "Member 'UQuestMiniTile2_C::AllowSelection' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, Label_Text_Style) == 0x0002F0, "Member 'UQuestMiniTile2_C::Label_Text_Style' has a wrong offset!");
static_assert(offsetof(UQuestMiniTile2_C, UseTinyMode) == 0x0002F8, "Member 'UQuestMiniTile2_C::UseTinyMode' has a wrong offset!");
