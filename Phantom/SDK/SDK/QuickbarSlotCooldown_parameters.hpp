...
static_assert(offsetof(QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown, K2Node_SwitchEnum2_CmpSuccess) == 0x000007, "Member 'QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown::K2Node_SwitchEnum2_CmpSuccess' has a wrong offset!");
static_assert(offsetof(QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown, K2Node_SwitchEnum3_CmpSuccess) == 0x000008, "Member 'QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown::K2Node_SwitchEnum3_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown, K2Node_SwitchEnum4_CmpSuccess) == 0x00000A, "Member 'QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown::K2Node_SwitchEnum4_CmpSuccess' has a wrong offset!");
static_assert(offsetof(QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown, K2Node_SwitchEnum5_CmpSuccess) == 0x00000B, "Member 'QuickbarSlotCooldown_C_ExecuteUbergraph_QuickbarSlotCooldown::K2Node_SwitchEnum5_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(QuickbarSlotCooldown_C_Initialize, Temp_object_Variable2) == 0x000030, "Member 'QuickbarSlotCooldown_C_Initialize::Temp_object_Variable2' has a wrong offset!");
static_assert(offsetof(QuickbarSlotCooldown_C_Initialize, Temp_object_Variable3) == 0x000038, "Member 'QuickbarSlotCooldown_C_Initialize::Temp_object_Variable3' has a wrong offset!");
static_assert(offsetof(QuickbarSlotCooldown_C_Initialize, Temp_object_Variable4) == 0x000040, "Member 'QuickbarSlotCooldown_C_Initialize::Temp_object_Variable4' has a wrong offset!");
static_assert(offsetof(QuickbarSlotCooldown_C_Initialize, Temp_object_Variable5) == 0x000048, "Member 'QuickbarSlotCooldown_C_Initialize::Temp_object_Variable5' has a wrong offset!");
static_assert(offsetof(QuickbarSlotCooldown_C_Initialize, Temp_object_Variable6) == 0x000050, "Member 'QuickbarSlotCooldown_C_Initialize::Temp_object_Variable6' has a wrong offset!");
