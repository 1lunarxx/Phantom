...
static_assert(offsetof(RewardsIcon_C_PlayHideAnimation, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000010, "Member 'RewardsIcon_C_PlayHideAnimation::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RewardsIcon_C_PlayShowAnimation, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'RewardsIcon_C_PlayShowAnimation::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
