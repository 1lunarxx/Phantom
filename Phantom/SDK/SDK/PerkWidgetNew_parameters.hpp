...
static_assert(offsetof(PerkWidgetNew_C_InitializeSettings, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x0000A8, "Member 'PerkWidgetNew_C_InitializeSettings::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
