...
static_assert(offsetof(StatsListItemWIdget_C_Initial_Reset, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'StatsListItemWIdget_C_Initial_Reset::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(StatsListItemWIdget_C_Populate_Update, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'StatsListItemWIdget_C_Populate_Update::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
