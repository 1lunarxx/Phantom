...
public:
	...
	struct FFortChallengeBundleInfoLockedReason   CallFunc_IsUnlocked_LockedReason;                  // 0x00E8(0x0010)(NoDestructor)
	bool                                          CallFunc_IsUnlocked_ReturnValue;                   // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_MakeLiteralString_ReturnValue;            // 0x0100(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_ContainsReward_ReturnValue;               // 0x0110(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_111[0x3];                                      // 0x0111(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Temp_float_Variable1;                              // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              K2Node_Select_Default;                             // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortQuestState                               CallFunc_GetQuestState_ReturnValue;                // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ChallengeQuestWidget_C_SetQuestItem) == 0x000120, "Wrong size on ChallengeQuestWidget_C_SetQuestItem");
...
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, CallFunc_IsUnlocked_ReturnValue) == 0x0000F8, "Member 'ChallengeQuestWidget_C_SetQuestItem::CallFunc_IsUnlocked_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, CallFunc_MakeLiteralString_ReturnValue) == 0x000100, "Member 'ChallengeQuestWidget_C_SetQuestItem::CallFunc_MakeLiteralString_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, CallFunc_ContainsReward_ReturnValue) == 0x000110, "Member 'ChallengeQuestWidget_C_SetQuestItem::CallFunc_ContainsReward_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, Temp_float_Variable1) == 0x000114, "Member 'ChallengeQuestWidget_C_SetQuestItem::Temp_float_Variable1' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, K2Node_Select_Default) == 0x000118, "Member 'ChallengeQuestWidget_C_SetQuestItem::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, CallFunc_GetQuestState_ReturnValue) == 0x000119, "Member 'ChallengeQuestWidget_C_SetQuestItem::CallFunc_GetQuestState_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, Temp_bool_Variable1) == 0x00011A, "Member 'ChallengeQuestWidget_C_SetQuestItem::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, K2Node_SwitchEnum_CmpSuccess) == 0x00011B, "Member 'ChallengeQuestWidget_C_SetQuestItem::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ChallengeQuestWidget_C_SetQuestItem, K2Node_Select1_Default) == 0x00011C, "Member 'ChallengeQuestWidget_C_SetQuestItem::K2Node_Select1_Default' has a wrong offset!");
