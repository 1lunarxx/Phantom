...
static_assert(sizeof(UGA_Generic_BotTurretExplosion_C) == 0x000950, "Wrong size on UGA_Generic_BotTurretExplosion_C");
static_assert(offsetof(UGA_Generic_BotTurretExplosion_C, UberGraphFrame) == 0x000940, "Member 'UGA_Generic_BotTurretExplosion_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Generic_BotTurretExplosion_C, EC_Explosion) == 0x000948, "Member 'UGA_Generic_BotTurretExplosion_C::EC_Explosion' has a wrong offset!");
