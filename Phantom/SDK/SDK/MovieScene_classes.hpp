...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x0007D8, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x000780, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x000790, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
