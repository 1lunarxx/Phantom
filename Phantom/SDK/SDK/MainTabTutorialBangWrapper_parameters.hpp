...
static_assert(offsetof(MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper, K2Node_CreateDelegate_OutputDelegate) == 0x000070, "Member 'MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
struct alignas(0x08) MainTabTutorialBangWrapper_C_OnStartCallout final
{
public:
...
static_assert(alignof(MainTabTutorialBangWrapper_C_OnStartCallout) == 0x000008, "Wrong alignment on MainTabTutorialBangWrapper_C_OnStartCallout");
static_assert(sizeof(MainTabTutorialBangWrapper_C_OnStartCallout) == 0x000010, "Wrong size on MainTabTutorialBangWrapper_C_OnStartCallout");
