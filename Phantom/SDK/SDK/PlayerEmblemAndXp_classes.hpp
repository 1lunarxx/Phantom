...
static_assert(sizeof(UPlayerEmblemAndXp_C) == 0x0002B0, "Wrong size on UPlayerEmblemAndXp_C");
...
static_assert(offsetof(UPlayerEmblemAndXp_C, MiniReward2HB) == 0x000290, "Member 'UPlayerEmblemAndXp_C::MiniReward2HB' has a wrong offset!");
static_assert(offsetof(UPlayerEmblemAndXp_C, MiniReward2Info) == 0x000298, "Member 'UPlayerEmblemAndXp_C::MiniReward2Info' has a wrong offset!");
static_assert(offsetof(UPlayerEmblemAndXp_C, MiniReward2LevelTB) == 0x0002A0, "Member 'UPlayerEmblemAndXp_C::MiniReward2LevelTB' has a wrong offset!");
static_assert(offsetof(UPlayerEmblemAndXp_C, SeasonNameLabel) == 0x0002A8, "Member 'UPlayerEmblemAndXp_C::SeasonNameLabel' has a wrong offset!");
