...
static_assert(sizeof(UAthenaChallengeTreeEntry_C) == 0x000C18, "Wrong size on UAthenaChallengeTreeEntry_C");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, UberGraphFrame) == 0x000B38, "Member 'UAthenaChallengeTreeEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BattleStars) == 0x000B40, "Member 'UAthenaChallengeTreeEntry_C::BattleStars' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BattleStarsCheck) == 0x000B48, "Member 'UAthenaChallengeTreeEntry_C::BattleStarsCheck' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BattleStarSwitcher) == 0x000B50, "Member 'UAthenaChallengeTreeEntry_C::BattleStarSwitcher' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BattleStarTracker) == 0x000B58, "Member 'UAthenaChallengeTreeEntry_C::BattleStarTracker' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BundleNumber) == 0x000B60, "Member 'UAthenaChallengeTreeEntry_C::BundleNumber' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BundleSB) == 0x000B68, "Member 'UAthenaChallengeTreeEntry_C::BundleSB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, BundleType) == 0x000B70, "Member 'UAthenaChallengeTreeEntry_C::BundleType' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, ChallengeBundleCategoryHeader) == 0x000B78, "Member 'UAthenaChallengeTreeEntry_C::ChallengeBundleCategoryHeader' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, ChallengeProgressWidget) == 0x000B80, "Member 'UAthenaChallengeTreeEntry_C::ChallengeProgressWidget' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, ChaseRewardCard) == 0x000B88, "Member 'UAthenaChallengeTreeEntry_C::ChaseRewardCard' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, ExpansionIndicator) == 0x000B90, "Member 'UAthenaChallengeTreeEntry_C::ExpansionIndicator' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, FillCB) == 0x000B98, "Member 'UAthenaChallengeTreeEntry_C::FillCB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, Glow) == 0x000BA0, "Member 'UAthenaChallengeTreeEntry_C::Glow' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, GradCB) == 0x000BA8, "Member 'UAthenaChallengeTreeEntry_C::GradCB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, HeaderHB) == 0x000BB0, "Member 'UAthenaChallengeTreeEntry_C::HeaderHB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, ItemCardOverlay) == 0x000BB8, "Member 'UAthenaChallengeTreeEntry_C::ItemCardOverlay' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, ItemIcon) == 0x000BC0, "Member 'UAthenaChallengeTreeEntry_C::ItemIcon' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, LockCheckSwitcher) == 0x000BC8, "Member 'UAthenaChallengeTreeEntry_C::LockCheckSwitcher' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, LockedReasonDisplay) == 0x000BD0, "Member 'UAthenaChallengeTreeEntry_C::LockedReasonDisplay' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, MainEntryTypeSwitcher) == 0x000BD8, "Member 'UAthenaChallengeTreeEntry_C::MainEntryTypeSwitcher' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, MiddleSectionSwitcher) == 0x000BE0, "Member 'UAthenaChallengeTreeEntry_C::MiddleSectionSwitcher' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, MidSectionCompleteVB) == 0x000BE8, "Member 'UAthenaChallengeTreeEntry_C::MidSectionCompleteVB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, MidSectionLockedVB) == 0x000BF0, "Member 'UAthenaChallengeTreeEntry_C::MidSectionLockedVB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, NormalBangWrapper) == 0x000BF8, "Member 'UAthenaChallengeTreeEntry_C::NormalBangWrapper' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, OutlineCB) == 0x000C00, "Member 'UAthenaChallengeTreeEntry_C::OutlineCB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, RewardBoxCB) == 0x000C08, "Member 'UAthenaChallengeTreeEntry_C::RewardBoxCB' has a wrong offset!");
static_assert(offsetof(UAthenaChallengeTreeEntry_C, RewardSpacingLine) == 0x000C10, "Member 'UAthenaChallengeTreeEntry_C::RewardSpacingLine' has a wrong offset!");
