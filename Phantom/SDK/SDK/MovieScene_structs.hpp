...
static_assert(sizeof(FGeneratedMovieSceneKeyStruct) == 0x000060, "Wrong size on FGeneratedMovieSceneKeyStruct");
...
static_assert(sizeof(FMovieSceneObjectPathChannel) == 0x0000B8, "Wrong size on FMovieSceneObjectPathChannel");
...
static_assert(sizeof(FMovieSceneSequenceReplProperties) == 0x00000C, "Wrong size on FMovieSceneSequenceReplProperties");
