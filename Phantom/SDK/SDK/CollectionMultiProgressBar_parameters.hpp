...
static_assert(sizeof(CollectionMultiProgressBar_C_Setup) == 0x000138, "Wrong size on CollectionMultiProgressBar_C_Setup");
...
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, K2Node_MakeStruct_SlateChildSize1) == 0x000110, "Member 'CollectionMultiProgressBar_C_Setup::K2Node_MakeStruct_SlateChildSize1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_GetOwningPlayer_ReturnValue1) == 0x000118, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_GetOwningPlayer_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_Create_ReturnValue1) == 0x000120, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_Create_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_AddChildToHorizontalBox_ReturnValue1) == 0x000128, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_AddChildToHorizontalBox_ReturnValue1' has a wrong offset!");
...
static_assert(alignof(CollectionMultiProgressBar_C_PlayFlashAnimation) == 0x000008, "Wrong alignment on CollectionMultiProgressBar_C_PlayFlashAnimation");
static_assert(sizeof(CollectionMultiProgressBar_C_PlayFlashAnimation) == 0x000008, "Wrong size on CollectionMultiProgressBar_C_PlayFlashAnimation");
static_assert(offsetof(CollectionMultiProgressBar_C_PlayFlashAnimation, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'CollectionMultiProgressBar_C_PlayFlashAnimation::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
