...
static_assert(offsetof(ItemCardWidget_C_ExecuteUbergraph_ItemCardWidget, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000008, "Member 'ItemCardWidget_C_ExecuteUbergraph_ItemCardWidget::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
