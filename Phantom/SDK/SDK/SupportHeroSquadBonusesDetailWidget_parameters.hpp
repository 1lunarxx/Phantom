...
static_assert(alignof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged) == 0x000008, "Wrong alignment on SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged");
static_assert(sizeof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged) == 0x000020, "Wrong size on SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged");
...
static_assert(offsetof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged, CallFunc_GetIdOfSquadSlotToManageBP_OutSquadId) == 0x000010, "Member 'SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged::CallFunc_GetIdOfSquadSlotToManageBP_OutSquadId' has a wrong offset!");
static_assert(offsetof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged, CallFunc_GetIdOfSquadSlotToManageBP_OutSquadSlotIndex) == 0x000018, "Member 'SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged::CallFunc_GetIdOfSquadSlotToManageBP_OutSquadSlotIndex' has a wrong offset!");
static_assert(offsetof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged, CallFunc_EqualEqual_NameName_ReturnValue) == 0x00001C, "Member 'SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00001D, "Member 'SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged, CallFunc_BooleanAND_ReturnValue) == 0x00001E, "Member 'SupportHeroSquadBonusesDetailWidget_C_HandleSquadSlotChanged::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
