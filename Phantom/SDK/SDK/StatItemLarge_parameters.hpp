...
static_assert(offsetof(StatItemLarge_C_ExecuteUbergraph_StatItemLarge, K2Node_Event_IsDesignTime) == 0x000004, "Member 'StatItemLarge_C_ExecuteUbergraph_StatItemLarge::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(StatItemLarge_C_ExecuteUbergraph_StatItemLarge, K2Node_Event_Delta) == 0x000008, "Member 'StatItemLarge_C_ExecuteUbergraph_StatItemLarge::K2Node_Event_Delta' has a wrong offset!");
...
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_byte_Variable2) == 0x00003A, "Member 'StatItemLarge_C_UpdateValue::Temp_byte_Variable2' has a wrong offset!");
...
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_byte_Variable3) == 0x00003C, "Member 'StatItemLarge_C_UpdateValue::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_byte_Variable4) == 0x00003D, "Member 'StatItemLarge_C_UpdateValue::Temp_byte_Variable4' has a wrong offset!");
...
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_byte_Variable5) == 0x000051, "Member 'StatItemLarge_C_UpdateValue::Temp_byte_Variable5' has a wrong offset!");
...
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_struct_Variable2) == 0x00007C, "Member 'StatItemLarge_C_UpdateValue::Temp_struct_Variable2' has a wrong offset!");
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_struct_Variable3) == 0x000084, "Member 'StatItemLarge_C_UpdateValue::Temp_struct_Variable3' has a wrong offset!");
static_assert(offsetof(StatItemLarge_C_UpdateValue, Temp_byte_Variable6) == 0x00008C, "Member 'StatItemLarge_C_UpdateValue::Temp_byte_Variable6' has a wrong offset!");
...
static_assert(offsetof(StatItemLarge_C_UpdateValue, K2Node_Select2_Default) == 0x0000A8, "Member 'StatItemLarge_C_UpdateValue::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(StatItemLarge_C_UpdateValue, K2Node_Select3_Default) == 0x0000A9, "Member 'StatItemLarge_C_UpdateValue::K2Node_Select3_Default' has a wrong offset!");
