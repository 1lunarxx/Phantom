...
public:
	...
	ESlateVisibility                              Temp_byte_Variable3;                               // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFortChallengeBundleInfoLockedReason   CallFunc_IsUnlocked_LockedReason;                  // 0x0068(0x0010)(NoDestructor)
	...
	bool                                          CallFunc_OwnsBattlePass_ReturnValue;               // 0x007A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_7B[0x5];                                       // 0x007B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortChallengeBundleItemDefinition*     CallFunc_GetBundleDefinition_ReturnValue;          // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetNumVisibleQuests_ReturnValue;          // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetRewardCompletionThreshold_ReturnValue; // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_GetDisplayName_ReturnValue;               // 0x0170(0x0018)()
	class FText                                   CallFunc_TextToUpper_ReturnValue;                  // 0x0188(0x0018)()
	class FText                                   K2Node_Select3_Default;                            // 0x01A0(0x0018)()
	class UFortItem*                              CallFunc_GetRewardItem_ReturnValue;                // 0x01B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetNumInStack_ReturnValue;                // 0x01C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1C4[0x4];                                      // 0x01C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortItemDefinition*                    CallFunc_GetItemDefinitionBP_ReturnValue;          // 0x01C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortItemQuantityPair                  CallFunc_MakeItemQuantityPair_ReturnValue;         // 0x01D0(0x0040)()
};
static_assert(alignof(ChallengeBundlePage_C_UpdateBundle) == 0x000008, "Wrong alignment on ChallengeBundlePage_C_UpdateBundle");
static_assert(sizeof(ChallengeBundlePage_C_UpdateBundle) == 0x000210, "Wrong size on ChallengeBundlePage_C_UpdateBundle");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_bool_Variable) == 0x000000, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_byte_Variable) == 0x000001, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_byte_Variable1) == 0x000002, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_IsInZone_ReturnValue) == 0x000010, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_IsInZone_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_byte_Variable2) == 0x000020, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_byte_Variable3) == 0x000021, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_bool_Variable1) == 0x000022, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, Temp_bool_Variable2) == 0x000023, "Member 'ChallengeBundlePage_C_UpdateBundle::Temp_bool_Variable2' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_IsUnlocked_LockedReason) == 0x000068, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_IsUnlocked_LockedReason' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, K2Node_Select1_Default) == 0x000079, "Member 'ChallengeBundlePage_C_UpdateBundle::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_OwnsBattlePass_ReturnValue) == 0x00007A, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_OwnsBattlePass_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetBundleDefinition_ReturnValue) == 0x000080, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetBundleDefinition_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetNumVisibleQuests_ReturnValue) == 0x000088, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetNumVisibleQuests_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, K2Node_Select2_Default) == 0x00008C, "Member 'ChallengeBundlePage_C_UpdateBundle::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetRewardCompletionThreshold_ReturnValue) == 0x000090, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetRewardCompletionThreshold_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, K2Node_MakeStruct_FormatArgumentData) == 0x000098, "Member 'ChallengeBundlePage_C_UpdateBundle::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, K2Node_MakeStruct_FormatArgumentData1) == 0x0000D8, "Member 'ChallengeBundlePage_C_UpdateBundle::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, K2Node_MakeArray_Array1) == 0x000128, "Member 'ChallengeBundlePage_C_UpdateBundle::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_Format_ReturnValue) == 0x000138, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_Format_ReturnValue1) == 0x000150, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_Format_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000168, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetDisplayName_ReturnValue) == 0x000170, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_TextToUpper_ReturnValue) == 0x000188, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, K2Node_Select3_Default) == 0x0001A0, "Member 'ChallengeBundlePage_C_UpdateBundle::K2Node_Select3_Default' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetRewardItem_ReturnValue) == 0x0001B8, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetRewardItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetNumInStack_ReturnValue) == 0x0001C0, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetNumInStack_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_GetItemDefinitionBP_ReturnValue) == 0x0001C8, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_GetItemDefinitionBP_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateBundle, CallFunc_MakeItemQuantityPair_ReturnValue) == 0x0001D0, "Member 'ChallengeBundlePage_C_UpdateBundle::CallFunc_MakeItemQuantityPair_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_BooleanOR_ReturnValue6;                   // 0x0012(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(ChallengeBundlePage_C_UpdateQuests) == 0x000014, "Wrong size on ChallengeBundlePage_C_UpdateQuests");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_BooleanOR_ReturnValue) == 0x000006, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_UpdateQuestList_HasClaimableQuests2) == 0x000007, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_UpdateQuestList_HasClaimableQuests2' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_BooleanOR_ReturnValue1) == 0x000008, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_UpdateQuestList_HasClaimableQuests3) == 0x000009, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_UpdateQuestList_HasClaimableQuests3' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_BooleanOR_ReturnValue2) == 0x00000A, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_BooleanOR_ReturnValue2' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_UpdateQuestList_HasClaimableQuests4) == 0x00000B, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_UpdateQuestList_HasClaimableQuests4' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_BooleanOR_ReturnValue3) == 0x00000C, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_BooleanOR_ReturnValue3' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_UpdateQuestList_HasClaimableQuests5) == 0x00000D, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_UpdateQuestList_HasClaimableQuests5' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_BooleanOR_ReturnValue4) == 0x00000E, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_BooleanOR_ReturnValue4' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_UpdateQuestList_HasClaimableQuests6) == 0x00000F, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_UpdateQuestList_HasClaimableQuests6' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, CallFunc_BooleanOR_ReturnValue6) == 0x000012, "Member 'ChallengeBundlePage_C_UpdateQuests::CallFunc_BooleanOR_ReturnValue6' has a wrong offset!");
static_assert(offsetof(ChallengeBundlePage_C_UpdateQuests, K2Node_Select_Default) == 0x000013, "Member 'ChallengeBundlePage_C_UpdateQuests::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_Play_Intro, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'ChallengeBundlePage_C_Play_Intro::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ChallengeBundlePage_C_Initial_Reset, CallFunc_PlayAnimationAtTime_ReturnValue) == 0x000000, "Member 'ChallengeBundlePage_C_Initial_Reset::CallFunc_PlayAnimationAtTime_ReturnValue' has a wrong offset!");
