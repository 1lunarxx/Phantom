...
static_assert(sizeof(UMainTabsScreen_C) == 0x0003A8, "Wrong size on UMainTabsScreen_C");
static_assert(offsetof(UMainTabsScreen_C, UberGraphFrame) == 0x000380, "Member 'UMainTabsScreen_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMainTabsScreen_C, TopTabContentWidgetSwitcher) == 0x000388, "Member 'UMainTabsScreen_C::TopTabContentWidgetSwitcher' has a wrong offset!");
static_assert(offsetof(UMainTabsScreen_C, LastActiveTabId) == 0x000390, "Member 'UMainTabsScreen_C::LastActiveTabId' has a wrong offset!");
static_assert(offsetof(UMainTabsScreen_C, UnclaimedResearchBangThreshold) == 0x000398, "Member 'UMainTabsScreen_C::UnclaimedResearchBangThreshold' has a wrong offset!");
static_assert(offsetof(UMainTabsScreen_C, UnclaimedResearchPointsHandle) == 0x0003A0, "Member 'UMainTabsScreen_C::UnclaimedResearchPointsHandle' has a wrong offset!");
