...
static_assert(offsetof(UDailyRewardsCurrent_C, UberGraphFrame) == 0x000240, "Member 'UDailyRewardsCurrent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UDailyRewardsCurrent_C, Flare_Backing) == 0x000248, "Member 'UDailyRewardsCurrent_C::Flare_Backing' has a wrong offset!");
static_assert(offsetof(UDailyRewardsCurrent_C, FortItemCard) == 0x000250, "Member 'UDailyRewardsCurrent_C::FortItemCard' has a wrong offset!");
static_assert(offsetof(UDailyRewardsCurrent_C, ImageRarityFlare) == 0x000258, "Member 'UDailyRewardsCurrent_C::ImageRarityFlare' has a wrong offset!");
static_assert(offsetof(UDailyRewardsCurrent_C, ItemName) == 0x000260, "Member 'UDailyRewardsCurrent_C::ItemName' has a wrong offset!");
