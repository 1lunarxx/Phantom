...
static_assert(offsetof(UMissionDifficultyIncreasePanel_C, HoverState_Off) == 0x000270, "Member 'UMissionDifficultyIncreasePanel_C::HoverState_Off' has a wrong offset!");
...
static_assert(offsetof(UMissionDifficultyIncreasePanel_C, HoverState_On) == 0x000280, "Member 'UMissionDifficultyIncreasePanel_C::HoverState_On' has a wrong offset!");
