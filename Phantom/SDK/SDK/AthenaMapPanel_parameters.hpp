...
static_assert(offsetof(AthenaMapPanel_C_ExecuteUbergraph_AthenaMapPanel, CallFunc_IsTouchInputPlatform_ReturnValue) == 0x000004, "Member 'AthenaMapPanel_C_ExecuteUbergraph_AthenaMapPanel::CallFunc_IsTouchInputPlatform_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaMapPanel_C_ExecuteUbergraph_AthenaMapPanel, CallFunc_IsMobileGame_ReturnValue) == 0x000020, "Member 'AthenaMapPanel_C_ExecuteUbergraph_AthenaMapPanel::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
