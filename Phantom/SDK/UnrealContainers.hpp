...
{	
	...
	struct FMemory
	{
		static inline uintptr_t ImageBase = reinterpret_cast<uintptr_t>(GetModuleHandleA(0));
		...
		{
			static void* (*Free)(void*) = decltype(Free)(ImageBase + 0x172A9B0);
			Free(Original);
		}
	};
