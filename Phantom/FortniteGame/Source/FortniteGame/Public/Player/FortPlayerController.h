...
private:
	...
	static void ServerCraftSchematic_Implementation(AFortPlayerController* FortPlayerController, const FString* ItemId, unsigned int PostCraftSlot, unsigned int CraftAmount, EFortItemTier RequestedTier, bool bIsQuickCrafted);
